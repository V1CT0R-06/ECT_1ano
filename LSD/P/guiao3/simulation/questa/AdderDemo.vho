...
SIGNAL \inst5|Add0~5_cout\ : std_logic;
...
-- Equation(s):
-- \inst5|Add0~0_combout\ = \SW[13]~input_o\ $ (\KEY[0]~input_o\)
...
-- Equation(s):
-- \inst5|Add0~1_combout\ = \SW[12]~input_o\ $ (\KEY[0]~input_o\)
...
-- Equation(s):
-- \inst5|Add0~2_combout\ = \KEY[0]~input_o\ $ (\SW[11]~input_o\)
...
\inst5|Add0~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst5|Add0~3_combout\ = \SW[10]~input_o\ $ (\KEY[0]~input_o\)
...
\inst5|Add0~5\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst5|Add0~5_cout\ = CARRY(\KEY[0]~input_o\)
...
PORT MAP (
	datab => \KEY[0]~input_o\,
	datad => VCC,
	cout => \inst5|Add0~5_cout\);

-- Location: LCCOMB_X112_Y13_N20
\inst5|Add0~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst5|Add0~6_combout\ = (\inst5|Add0~3_combout\ & ((\SW[14]~input_o\ & (\inst5|Add0~5_cout\ & VCC)) # (!\SW[14]~input_o\ & (!\inst5|Add0~5_cout\)))) # (!\inst5|Add0~3_combout\ & ((\SW[14]~input_o\ & (!\inst5|Add0~5_cout\)) # (!\SW[14]~input_o\ & 
-- ((\inst5|Add0~5_cout\) # (GND)))))
-- \inst5|Add0~7\ = CARRY((\inst5|Add0~3_combout\ & (!\SW[14]~input_o\ & !\inst5|Add0~5_cout\)) # (!\inst5|Add0~3_combout\ & ((!\inst5|Add0~5_cout\) # (!\SW[14]~input_o\))))
...
-- Equation(s):
-- \inst5|Add0~8_combout\ = ((\SW[15]~input_o\ $ (\inst5|Add0~2_combout\ $ (!\inst5|Add0~7\)))) # (GND)
-- \inst5|Add0~9\ = CARRY((\SW[15]~input_o\ & ((\inst5|Add0~2_combout\) # (!\inst5|Add0~7\))) # (!\SW[15]~input_o\ & (\inst5|Add0~2_combout\ & !\inst5|Add0~7\)))
...
-- Equation(s):
-- \inst5|Add0~10_combout\ = (\inst5|Add0~1_combout\ & ((\SW[16]~input_o\ & (\inst5|Add0~9\ & VCC)) # (!\SW[16]~input_o\ & (!\inst5|Add0~9\)))) # (!\inst5|Add0~1_combout\ & ((\SW[16]~input_o\ & (!\inst5|Add0~9\)) # (!\SW[16]~input_o\ & ((\inst5|Add0~9\) # 
-- (GND)))))
-- \inst5|Add0~11\ = CARRY((\inst5|Add0~1_combout\ & (!\SW[16]~input_o\ & !\inst5|Add0~9\)) # (!\inst5|Add0~1_combout\ & ((!\inst5|Add0~9\) # (!\SW[16]~input_o\))))
...
-- Equation(s):
-- \inst5|Add0~12_combout\ = ((\SW[17]~input_o\ $ (\inst5|Add0~0_combout\ $ (!\inst5|Add0~11\)))) # (GND)
-- \inst5|Add0~13\ = CARRY((\SW[17]~input_o\ & ((\inst5|Add0~0_combout\) # (!\inst5|Add0~11\))) # (!\SW[17]~input_o\ & (\inst5|Add0~0_combout\ & !\inst5|Add0~11\)))
...
-- Equation(s):
-- \inst5|Add0~14_combout\ = \inst5|Add0~13\ $ (\KEY[0]~input_o\)
...
-- Equation(s):
-- \inst|bit1|cout~0_combout\ = (\SW[1]~input_o\ & ((\SW[5]~input_o\) # ((\SW[0]~input_o\ & \SW[4]~input_o\)))) # (!\SW[1]~input_o\ & (\SW[5]~input_o\ & (\SW[0]~input_o\ & \SW[4]~input_o\)))
