...
def main():
    ...
    # Ordena a tabela por ordem decrescente de pontos:
    tabela_ordenada = sorted(tabela, key=pontos, reverse=True)

    # Mostra a tabela ordenada:
    print("\nTabela ordenada por pontos (decrescente):")
    printTabela(tabela_ordenada)
